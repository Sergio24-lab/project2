...
namespace BlogCore.AccesoDatos.Data.Inicializador
{
    public class InicializadorBD : IInicializadorBD
    {
        ...
        public void Inicializar()
        {
            ...
            {
                UserName = "sergio.projec7@gmail.com",
                Email = "sergio.projec7@gmail.com",
                EmailConfirmed = true,
                Nombre = "Sergio"
            }, "Sergio.2020").GetAwaiter().GetResult();

            ApplicationUser usuario = _bd.ApplicationUser.
                Where(us => us.Email == "sergio.projec7@gmail.com").FirstOrDefault();
