...
namespace BlogCore.Areas.Cliente.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        {
            var articuloDesdeBd = _contenedorTrabajo.Articulo.GetPrimero(o => o.Id == id, includeProperties: "Categoria,Proveedor");
            ...
            {
                Articulo = articuloDesdeBd,
                ListaCategorias = _contenedorTrabajo.Categoria.GetListaCategorias().Select(c => new SelectListItem
                {
                    Text = c.Text,
                    Value = c.Value.ToString()
                }),
                ListaProveedores = _contenedorTrabajo.Proveedor.GetListaProveedores().Select(p => new SelectListItem
                {
                    Text = p.Text,
